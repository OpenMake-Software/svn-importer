 ...
 */
public class SvnChangeFile extends SvnAddFile {
	public SvnChangeFile(String path, SvnBranch branch, IContentRetriever contentRetriever) {
		super(path, branch, contentRetriever, "change");
	}
}
