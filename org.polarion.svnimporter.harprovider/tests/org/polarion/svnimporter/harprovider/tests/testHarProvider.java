 ...
 * $Log$
 */
package org.polarion.svnimporter.harprovider.tests;
 ...
 */
public class testHarProvider extends BaseProviderTest {
    private static final Log log = Log.getLog(testHarProvider.class);
    ...
    protected void initProvider(File testDir) throws Exception {
        ...
        HarProvider p = new PvcsProvider2(
    ...
    private class PvcsProvider2 extends HarProvider {
